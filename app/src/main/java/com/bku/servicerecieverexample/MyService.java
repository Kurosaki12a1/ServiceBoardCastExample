...
public class MyService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
      //  Toast.makeText(getApplicationContext(), "onStartCommand", Toast.LENGTH_LONG).show();
        ...
        //nó chỉ xác định nghe cái bộ lọc có chứa intent này thôi ACTION_MSG_TO_SERVICE
    ...
    public class MyServiceReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(action.equals(ACTION_MSG_TO_SERVICE)){
                ...
                Intent i = new Intent();
                //nó sẽ chuyển qua reciver có action ACTION_UPDATE_MSG ( Main Activity)
